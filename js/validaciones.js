...
const mensajesDeError = {
    ...
    ciudad: {
        valueMissing: "Este campo no puede estar vacío",
        patternMismatch: "La ciudad debe contener entre 3 y 40 caracteres."      
    },
    estado: {
        valueMissing: "Este campo no puede estar vacío",
...
function validarNacimiento(input){
    ...
    input.setCustomValidity(mensaje); // Se genera un mensaje de error si no se cumplen las condiciones
};
